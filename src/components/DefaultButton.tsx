...
export const DefaultButton = ({ title, small, disabled }: DefaultButtonProps) => {
  ...
  return (
    <button
      ...
      } px-12 py-4 text-center text-white text-[22px] font-extrabold uppercase bg-gradient-to-b from-cyan-500 to-sky-700 rounded-3xl shadow border-4 border-blue-950 justify-center items-center inline-flex hover:brightness-110 focus:brightness-110`}
    >
